                    ...
                    <div class="overflow-x-auto rounded-lg border border-D2DCB6">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <!-- Peringkat 1 (Contoh dari jurnal: Data Mining) -->
                                <tr class="bg-green-100/50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium text-gray-800">9</td>
                                </tr>
                                <!-- Peringkat 2 -->
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium text-gray-800">6</td>
                                </tr>
                                <!-- Peringkat 3 -->
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium text-gray-800">3</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
