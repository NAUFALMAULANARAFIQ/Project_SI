...
<head>
    ...
    <title>Data Kriteria & Bobot - SPK TOPSIS</title>
    ...
    <style>
        ...
        /* Active link color for Kriteria */
        .active-link-kriteria { background-color: #A1BC98; color: #778873; font-weight: 600; }
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-dark-sidebar text-white flex-shrink-0 z-20 shadow-xl">
            ...
            <nav class="p-4 space-y-2">
                ...
                <!-- Kriteria Link (ACTIVE, Fixed Link) -->
                <a href="/admin/kriteria" class="flex items-center p-3 rounded-lg active-link-kriteria transition duration-150">
            ...
            <div class="p-8">
                <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-secondary">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold text-primary">Kelola Kriteria & Bobot Preferensi</h2>
                    ...
                    <!-- Kriteria Table -->
                    <div class="overflow-x-auto rounded-lg border border-D2DCB6 mb-8">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="table-header">
                                    ...
                                    <th class="px-6 py-3 text-center text-xs font-semibold text-primary uppercase tracking-wider">Bobot (Wj)</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">C1</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">Tingkat Kesulitan</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-red-500 font-semibold">Cost</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-bold text-primary">4</td>
                                ...
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">C2</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">Referensi</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-500 font-semibold">Benefit</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-bold text-primary">3</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium space-x-2">
                                        <button class="text-blue-500 hover:text-blue-700 p-1 rounded-full transition duration-150" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/></svg>
                                        </button>
